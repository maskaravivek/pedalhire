...
Revision ID: 7a992c2b2267
Revises: 
Create Date: 2020-04-27 19:38:11.763641
...
def upgrade():
    ...
    sa.Column('role_type', sa.Enum('USER', 'MERCHANT', name='role'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('start_date', sa.DateTime(), nullable=False),
    sa.Column('end_date', sa.DateTime(), nullable=False),
    sa.Column('days', postgresql.ARRAY(sa.String(length=5)), nullable=True),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
